...
class InstitutionListingPage extends StatefulWidget {
  const InstitutionListingPage({super.key});

  @override
  _InstitutionListingPageState createState() => _InstitutionListingPageState();
}

class _InstitutionListingPageState extends State<InstitutionListingPage> {
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    .collection('users')
                    .where('category', isEqualTo: 'institution')
                    .snapshots(),
